        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-form>                       
                <form method="POST" action="{{action([App\Http\Controllers\UserController::class, 'profileInfoUpdate'])}}">
                    @csrf 
                    <div>
                        <x-label value="{{ __('messages.E-mail') }}" for="email"></x-label>
                    ...
                    <div>
                        <x-label value="{{ __('messages.Password') }}" for="password"></x-label>
                    ...
                    <div>
                        <x-label value="{{ __('messages.Confirm Password') }}" for="password_confirmation"></x-label>
                    ...
                    <div>
                        <x-label value="{{ __('messages.Name') }} " for="name"></x-label>
                    ...
                    <div>
                        <x-label value="{{ __('messages.Surname') }}" for="surname"></x-label>
                    ...
                    <div>
                        <x-label value="{{ __('messages.Birthday') }}" for="birthday"></x-label>
                    ...
                    <div>
                        <x-label value="{{ __('messages.Phone Number') }}" for="mobile_phone"></x-label>
